...
public class terms extends AppCompatActivity {
    ...
    String termstext= "\nOVERVIEW\n" +
            "\n" +
            "This mobile app is operated by Krashunt. Throughout the app, the terms “we”, “us” and “our” refer to Krashunt. Krashunt offers this app, including all information, tools and services available from this app to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.\n" +
            "\n" +
            ...
            "\n" +
            "Questions about the Terms of Service should be sent to us at innovation@krashunt.com.\n" +
            "\n";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView term = (TextView) findViewById(R.id.cond);

        term.setText(termstext);
